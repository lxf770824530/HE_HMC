...
if __name__ == '__main__':
    ...
    pl.dump(data_i_list, open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label\kfold_bestbuy', 'wb'))
    ks=pl.load(open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label\kfold_bestbuy', 'rb'))
    for train, test in ks:
        ...
        filepath = r"G:\HTMC-2\model\HE_HMC\bestbuy/gru_layer1_fold"+str(i)+".h5"
        checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=True)
        ...
        label_save_name = r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label\predict_label/layer1_fold'+str(i)+'_predict'
