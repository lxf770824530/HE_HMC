...
if __name__ == '__main__':
    ...
    train_txt, y1, y2, y3 = pl.load(open('G:\HTMC-2\DATA\processed_data\kaggle\data29633_digital_label/train_txt-len-y_300_pad0_glove', 'rb'))
    ...
    for train, test in ks:
        ...
        filepath = r"G:\HTMC-2\model\HE_HMC\KAGGLE/gru_layer3_fold"+str(i)+".h5"


        ty3_c = to_categorical(label3[test].tolist(), class_num_3)


        ty2_p = pl.load(open('G:\HTMC-2\DATA\processed_data\kaggle\data29633_digital_label\predict_label/layer2_fold'+str(i)+'_predict', 'rb'))                    #修改文件名 layer2_predict_we
