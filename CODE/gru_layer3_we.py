...
def createHierarchicalAttentionModel(maxSeq,
    ...
    labels_vector = pl.load(open('../DATA/WOS5736/label_2_vector', 'rb'))
...
if __name__ == '__main__':
    filepath = "../DATA/WOS5736/gru_layer3_we.h5"
    checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=True)
    pretrained_w2v, _, _ = pl.load(open('../DATA/WOS5736/emb_matrix_glove_300', 'rb'))
    train_txt, y1, y2, y3 = pl.load(open('train_txt-y123_300_pad0_glove', 'rb'))      #3层
    test_txt, ty1, ty2, ty3 = pl.load(open('test_txt-y123_300_pad0_glove', 'rb'))
