...
if __name__ == '__main__':
    ...
    for train, test in ks:
        ...
        ty1_p = pl.load(open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label\predict_label/layer1_fold'+str(i)+'_predict','rb'))     #修改文件名 layer2_predict_we



        mode=keras.models.load_model(filepath)    #加载模型

        # loss,acc=mode.evaluate([data[test], ty1_p], [ty2_c], batch_size=256)
