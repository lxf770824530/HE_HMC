...
def createHierarchicalAttentionModel(maxSeq,
    ...
    labels_vector = pl.load(open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label/label_2_vector', 'rb'))
...
if __name__ == '__main__':
    filepath = r"G:\HTMC-2\model\HE_HMC\ablation_study\word_Embedding\bestbuy/gru_layer3_we.h5"
    ...
    label_save_name = r'G:\HTMC-2\model\HE_HMC\ablation_study\word_Embedding\bestbuy/layer3_predict'
