...
def createHierarchicalAttentionModel(maxSeq,
    ...
    labels_vector = pl.load(open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label/label_1_vector', 'rb'))
...
if __name__ == '__main__':
    filepath = r"G:\HTMC-2\model\HE_HMC\ablation_study\word_Embedding\bestbuy/gru_layer2_we.h5"
    ...
    # train_txt, y1, y2, y3 = pl.load(open(r'G:\HTMC-2\DATA\processed_data\bestbuy\bestbuy_digital_label/train_txt-len-y_300_pad0_glove', 'rb'))      #3层
    ...
    label_save_name = r'G:\HTMC-2\model\HE_HMC\ablation_study\word_Embedding\bestbuy\predict_label/layer2_predict'
