...
if __name__ == '__main__':
    filepath = r"G:\HTMC-2\model\HE_HMC\ablation_study\bestbuy/gru_layer3.h5"
    ...
    # train_txt, y1, y2 = pl.load(open('../DATA/WOS11967/train_txt-len-y_300_pad0_glove', 'rb'))
    # test_txt, ty1, ty2= pl.load(open('../DATA/WOS11967/test_txt-len-y_300_pad0_glove', 'rb'))
    y3=to_categorical(y3,class_num)
    ty3=to_categorical(ty3,class_num)                                                                           #类别数调整
    ...
    mode.fit([train_txt],[y3],batch_size=64,epochs=150,validation_data=([test_txt,],[ty3]),callbacks=[checkpoint,early_stopping])
    ...
    label_save_name = r'G:\HTMC-2\model\HE_HMC\ablation_study\bestbuy\predict_label/layer3_predict'
